...
\epigraph{The Unruh effect tells us that what we call particles is really just a matter of perspective.}{Lee Smolin}
 ...
 \abstract{We analyze the quantum field theoretic framework where Unruh radiation was first described, interpreting thrust as a driving source field. The driving modes in the Rindler frame exhibit a smeared-out frequency spectrum due to red-blue shifting and thermodynamic ignorance, resulting in a thermalized response. To refine this picture, we construct an interpolation between these long-lived modes and more localized wave packets with a peaked Fourier transform, which do not exhibit this smeared-out property.}
