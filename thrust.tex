...
(\Box + m^2) \phi = \rho
\]
\cite{beisert}. It is usually assumed that the source will only be active for some finite amount of time.  We ignore this issue and instead go after the general asymptotic form of our solution in Fourier space.
