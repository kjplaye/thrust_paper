...
\item {\bf Stress-energy} A natural next step would be to evaluate stress–energy expectation values in the sourced state, to quantify the thrust mechanism more precisely.
