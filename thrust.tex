...
\end{enumerate}
The 2nd transition is a ``measurement'' in $\mathcal{A}$. This could be a measurement by a conscious observer, an interaction with a particle, or just a potential putative measurement.  The key here is an increase in total information in $\mathcal{A}$.  This is related exactly to an increase in total mass/energy by Landauer's principle.  The 1st transition is not a measurement in $\mathcal{A}$, but is a potential putative measurement in $\mathcal{H}$
