...
\caption{$\left|\left< \varphi_q N, r_k \right>\right|^2$ for various values of $\sigma$ (probability density is scaled for comparision). $\omega_q = 1$, $q = 1$, $a=1$, $\mu = 1$. See also corresponding Figure \ref{stokes}.}
