...
We can further localize by considering a reflected wedge $\widetilde{W_{2c}}$.  This is a much more localized diamond picture in Figure \ref{diamond}.  The mode $r_q$ is further restricted to be in the intersection of $W_c$ and $\widetilde{W_{2c}}$ and we don't encounter the infinite spread of lower frequencies.  The inner product is just the incomplete version of the beta function in equation (\ref{bogo2}).  We show several plot of what this looks like in Figure \ref{peaked}, we can see that the main peak remains and the thermal response at zero is attenuated.
