...
\]
Plugging this into equation (\ref{number}) we find a $(1,1)$-dimensional version of Plank's law\footnote{This is the average energy of the mode, not the average number of particles (see \cite{qspplanck}).}, and thus recover the Unruh radiation spectrum\footnote{Compare to equation (\ref{radeq}) and references \cite{unruh} and \cite{Frodden}.} from a thrust driven field.
\[
