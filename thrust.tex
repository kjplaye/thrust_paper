...
\caption{Phase of a Rindler mode $r_k$ analytically extended to the whole $UV$ or $TX$ plane. For $k>0$, $r_k$ is a function of $u$, the future horizon of $I = W$ which corrosponds to emission.  Wedges I and II are off by a factor of $e^{\frac{\pi \omega_k}{a}}$ from wedges III and IV analytically continued around the singular $u=0$.  A similar situation exists for $k<0$, absorption with $v$, and I, III vs. II, IV.}
\label{analytic}
\end{figure}
