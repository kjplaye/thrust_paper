...
\end{equation}
for $\nu = -\frac{i \omega_k}{a}$ and $-z = iq\sigma - \frac{\mu}{\sigma}$ when $-\frac{3}{4}\pi + \epsilon \le \arg z \le \frac{1}{4} \pi - \epsilon$.  The second $e^{\frac{1}{4}z^2}$ term dominates for $z \to \infty$ as $\sigma \to 0$ and the first  $e^{-\frac{1}{4}z^2}$ term dominates for $z \to -i \infty$ as $\sigma \to \infty$.  This is the Stokes phenomenon; and we cross the Stokes curve on the line $\arg z = -\frac{\pi}{4}$; The situation is picture in Figure \ref{stokes}.
