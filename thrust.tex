...
\begin{equation}
  \begin{aligned}
    ...
    &= \frac{1}{2\pi a} \sqrt{\frac{\omega_k}{\omega_q}} a^{\frac{i \omega_k}{a} } e^{-\frac{\mu^2}{2 \sigma^2}} \sigma^{\frac{i\omega_k}{a}} \int_0^\infty e^{(\frac{\mu}{\sigma} + i q \sigma)s} s^{\frac{i\omega_k}{a} - 1} e^{-\frac{1}{2} s^2} \dv{s}\\
    &= \frac{1}{2\pi a} \sqrt{\frac{\omega_k}{\omega_q}} {(\sigma a)}^{\frac{i \omega_k}{a}}  e^{-\frac{\mu^2}{2 \sigma^2}}e^{\frac{1}{4}(-i q \sigma - \frac{\mu}{\sigma})^2} \Gamma\left(\frac{i\omega_k}{a}\right) D_{-\frac{i\omega_k}{a}}(-i q\sigma - \frac{\mu}{\sigma}) \\
    &=  \frac{1}{2\pi a e^{\frac{\mu^2}{2 \sigma^2}}} \sqrt{\frac{\omega_k}{\omega_q}} (\sigma a)^\frac{i\omega_k}{a} e^{\frac{1}{4} z^2} \Gamma(-\nu) D_\nu(-z)
  \end{aligned}
\end{equation}
...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
And altogether we find that the asymptotics of the inner product interpolate between a thermal character and a localized character.
\begin{equation}
  \left|\left< \varphi_q N_{\mu,\sigma}, r_k \right>\right|^2 \rightarrow \left\{ \begin{array}{lll}
    \frac{1}{2\pi\omega_q} \frac{1}{e^{\frac{2\pi \omega_k}{a} - 1}}    & \text{as} & \sigma \to \infty     \vspace{10pt}
\\
    \frac{1}{2\pi\omega_q} \frac{\omega_k}{a} \frac{\sigma^2}{\mu^2}& \text{as} & \sigma \to 0 \\
  \end{array}  \right.  
\end{equation}
