...
pylab.text(-0.8,0.1, 'p_v = 0',fontsize = 'xx-large', rotation = -45)
pylab.text(0.3,0.1, 'p_u = 0',fontsize = 'xx-large', rotation = 45)
pylab.text(-0.4,0.8, 'p_u,p_v < 0',fontsize = 'xx-large')
